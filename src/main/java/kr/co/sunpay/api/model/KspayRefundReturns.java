...
@Setter
@ToString
public class KspayRefundReturns {
	...
	public KspayRefundReturns() {
		
	}
	
	public KspayRefundReturns(String rTransactionNo, String rStatus, String rTradeDate, String rTradeTime,
