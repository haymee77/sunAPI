...
public class KSPayApprovalCancelBean {
	...
	public String[] ApprovalType = new String[MAXSIZE], // 승인구분
			...
			Point1 = new String[MAXSIZE], Point2 = new String[MAXSIZE], Point3 = new String[MAXSIZE],
			Point4 = new String[MAXSIZE], VanTransactionNo = new String[MAXSIZE], // Van 거래번호
	...
	/* 가상계좌승인결과 */
	public String[] VATransactionNo = new String[MAXSIZE], VAStatus = new String[MAXSIZE],
			VATradeDate = new String[MAXSIZE], VATradeTime = new String[MAXSIZE], VABankCode = new String[MAXSIZE],
			VAVirAcctNo = new String[MAXSIZE], VAName = new String[MAXSIZE], VACloseDate = new String[MAXSIZE],
			VACloseTime = new String[MAXSIZE], VARespCode = new String[MAXSIZE], VAMessage1 = new String[MAXSIZE],
			VAMessage2 = new String[MAXSIZE], VAAmount = new String[MAXSIZE], VAFiller = new String[MAXSIZE];

	/* 월드패스승인결과 */
	public String[] WPTransactionNo = new String[MAXSIZE], WPStatus = new String[MAXSIZE],
			WPTradeDate = new String[MAXSIZE], WPTradeTime = new String[MAXSIZE], WPIssCode = new String[MAXSIZE], // 발급사코드
	...
	/* 포인트카드승인결과 */
	public String[] PTransactionNo = new String[MAXSIZE], // 거래번호
	...
	/* 현금영수증승인결과 */
	public String[] HTransactionNo = new String[MAXSIZE], // 거래번호
	...
	/* 핸드폰 인증1차 승인결과 */
	public String[] MB1ApprovalType = new String[MAXSIZE], /* 구분코드 */
	...
	/* 핸드폰 인증2차 승인결과 */
	public String[] MB2ApprovalType = new String[MAXSIZE], /* 구분코드 */
	...
	// 휴대폰결제결과
	public String[] MTransactionNo = new String[MAXSIZE], // 거래번호
	...
	/* 카드 BIN check 승인결과 */
	public String[] BINTransactionNo = new String[MAXSIZE], /* 거래번호 */
	...
	/* 상점상세정보 조회결과 */
	public String[] SITransactionNo = new String[MAXSIZE], // 거래번호
	...
	/* 계좌이체승인결과 */
	public String[] ACTransactionNo = new String[MAXSIZE], ACStatus = new String[MAXSIZE],
			ACTradeDate = new String[MAXSIZE], ACTradeTime = new String[MAXSIZE], ACAcctSele = new String[MAXSIZE],
			ACFeeSele = new String[MAXSIZE], ACInjaName = new String[MAXSIZE], ACPareBankCode = new String[MAXSIZE],
			ACPareAcctNo = new String[MAXSIZE], ACCustBankCode = new String[MAXSIZE],
			ACCustAcctNo = new String[MAXSIZE], ACAmount = new String[MAXSIZE],
			ACBankTransactionNo = new String[MAXSIZE], ACIpgumNm = new String[MAXSIZE], ACBankFee = new String[MAXSIZE],
			ACBankAmount = new String[MAXSIZE], ACBankRespCode = new String[MAXSIZE], ACMessage1 = new String[MAXSIZE],
			ACMessage2 = new String[MAXSIZE], ACEntrNumb = new String[MAXSIZE], ACShopPhone = new String[MAXSIZE],
			ACCavvSele = new String[MAXSIZE], ACFiller = new String[MAXSIZE], ACEncData = new String[MAXSIZE];
	...
	public KSPayApprovalCancelBean(String ServerName) throws IOException {
		...
		try {
			if (FileName == null)
				FileName = "/export/home/ipgadmin/cfg/new_env.cfg";

			FileInputStream in = new FileInputStream(FileName);
			Props.load(in);
		} catch (IOException e) {
			throw new IOException(
					"[KSPayApprovalCancelBean] Exception on config file\nYou must execute java -D IPGADMIN_PATH=filenameWithAbsolutePath classfile");
		}
	...
	public boolean HeadMessage(String pEncType, // 0: 암화안함, 1:openssl, 2: seed
	...
	// 신용카드승인요청 Body 1
	public boolean CreditDataMessage(String ApprovalType, // 승인구분
	...
	public boolean VirtualAccountDataMessage(String ApprovalType, // 승인구분
	...
	// 월드패스카드
	public boolean WorldPassDataMessage(String ApprovalType, // 승인구분
			String TrackII, // 카드번호=유효기간 or 거래번호
			String Passwd, // 비밀번호 앞2자리
			String Amount, // 금액
	...
	// 포인트카드승인
	public boolean PointDataMessage(String ApprovalType, // 승인구분
			String TrackII, // 카드번호=유효기간 or 거래번호
			String Amount, // 금액
	...
	// 현금영수증발급
	public boolean CashBillDataMessage(String ApprovalType, // H000:일반발급, H200:계좌이체, H600:가상계좌
	...
	// 핸드폰 인증1차
	public boolean Mobile1DataMessage(String ApprovalType, /* 구분코드 */
	...
	// 핸드폰 인증2차
	public boolean Mobile2DataMessage(String ApprovalType, /* 구분코드 */
	...
	// 핸드폰 결제1차
	public boolean MobileAppr1DataMessage(String ApprovalType, /* 구분코드 */
			String MobileNo, /* 휴대폰번호 */
			String SocialNo, /* 명의자 주민번호 */
			String UsersocialNo, /* LGT 실사용자 인증시에만 사용 */
			String Commsele, /* SKT, KTF, LGT */
	...
	// 핸드폰 결제2차
	public boolean MobileAppr2DataMessage(String ApprovalType, /* 구분코드 */
			String TransactionNo, /* 거래번호 */
			String Smsval, /* sms 인증코드 */
	...
	public boolean AcctRequest_send(String ApprovalType, // 승인구분
	...
	// 계좌이체 인증승인 요청전문을 만든다.
	public boolean AcctRequest_iappr(String ApprovalType, // 승인구분 코드
	...
	// 카드 취소
	public boolean CancelDataMessage(String ApprovalType, // 승인구분
	...
	// 카드 BIN check
	public boolean CardBinDataMessage(String ApprovalType, // 승인구분
			String TrackII, // 카드번호
			String Filler) // 기타
	{
		StringBuffer TmpSendMsg = new StringBuffer();
	...
	// 상점정보 상세요청(A700)
	public boolean ShopInfoDetailDataMessage(String ApprovalType, // 승인구분
			String ShopId, // 상점아이디
	...
	public boolean ReceiveMessage() throws IOException {
		...
		this.LineType = new String(this.KSPaySocket.read(1), MSG_ENCODING); // lineType 0 : offline, 1:internet,
																			// 2:Mobile
		...
		for (int i = 0; i < iCnt; i++) {
			...
			if (this.ApprovalType[i].substring(0, 1).equals("1") || this.ApprovalType[i].substring(0, 1).equals("I")) {
				if (this.ApprovalType[i].substring(1, 2).equals("5")) {
					...
					this.AuthSendType[i] = new String(this.KSPaySocket.read(1), MSG_ENCODING); // 전송구분= new
																								// String(this.read(2));
					this.ApprovalSendType[i] = new String(this.KSPaySocket.read(1), MSG_ENCODING); // 전송구분(0 : 거절, 1 :
																									// 승인, 2: 원카드)
					...
					this.AuthType[i] = new String(this.KSPaySocket.read(1), MSG_ENCODING); // I : ISP거래, M : MPI거래,
																							// SPACE : 일반거래
					this.MPIPositionType[i] = new String(this.KSPaySocket.read(1), MSG_ENCODING); // K : KSNET, R :
																									// Remote, C : 제3기관,
																									// SPACE : 일반거래
					...
					if (AuthType[i] == "" || AuthType[i].trim().equals("")) {
						...
						this.EncData[i] = new String(this.KSPaySocket.read(Integer.parseInt(EncLen)), MSG_ENCODING); // MPI,
																														// ISP
																														// 데이터
					}
			...
			// 핸드폰 인증 1차 : M020
				...
				this.MB1Serverinfo[i] = new String(this.KSPaySocket.read(128),
						MSG_ENCODING); /* 서버INFO : 업체에서는 보관 필요 없음 예비로 */
			...
			// 계좌이체시작요청
			else if (this.ApprovalType[i].substring(0, 3).equals("210")
					|| this.ApprovalType[i].substring(0, 3).equals("240")) {
				...
				this.ACAcctSele[i] = new String(this.KSPaySocket.read(1), MSG_ENCODING); // 계좌이체 구분 - 1:Dacom, 2:Pop
																							// Banking, 3:실시간계좌이체, 4:X
				...
				this.ReceiveMsg += TmpReceiveMsg.toString();
				System.out.println(
						"AcctRequest_send(2100,2400) ReceiveMsg[" + i + "]" + "=[" + TmpReceiveMsg.toString() + "]");
			}
			// 계좌이체결과반영요청 || 계좌이체승인요청 || 계좌이체취소요청
				...
				this.ReceiveMsg += TmpReceiveMsg.toString();
				System.out.println("AcctRequest_recv,appr(2200,2300,2420) ReceiveMsg[" + i + "]" + "=["
						+ TmpReceiveMsg.toString() + "]");
			}
			// 상점상세정보 조회결과
				...
				this.ReceiveMsg += TmpReceiveMsg.toString();
				System.out
						.println("ShopInfoDetail(A700) ReceiveMsg[" + i + "]" + "=[" + TmpReceiveMsg.toString() + "]");
			}
		}
		return true;
	}
	...
	public boolean SendSocket(String Flag) {
		...
		try {
			...
			state_flag = 9;
			/*
			 * state_flag = 0 성공 state_flag = 1 FEP와통신실패 state_flag = 2 BackUrl쓰기에 실패해 재취소를
			 * 하였음. state_flag = 3 BackUrl쓰기에 실패해 재취소를 하였으나 취소실패하였음. state_flag =
			 */
	...
	public static String format(String str, int len, char ctype) {
		...
		try {
			...
			if (filllen < 0) {
				...
				if (filllen <= 0)
					return new String(buff, 0, len, MSG_ENCODING);// 여기는 절대로 안타겠지...
				sb.setLength(0);
			} else {
				trim_str = str;
			}
	...
	public static String[] split(String srcStr, String str1) {
		...
		if (startPos <= srcLength)
			linkedlist.add(srcStr.substring(startPos));
